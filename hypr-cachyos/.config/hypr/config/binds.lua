...
hl.bind(mod .. " + CONTROL + M", hl.dsp.window.fullscreen({ mode = "maximized" }))
...
hl.bind(mod .. " + comma", hl.dsp.layout("orientationcycle top left bottom right"))
hl.bind(mod .. " + period", hl.dsp.layout("orientationcycle top right bottom left"))
...
hl.bind(mod .. " + R", command(noctalia .. "panel-toggle launcher"))
...
hl.bind(mod .. " + SHIFT + R", command("~/.local/bin/remarkable-push-workspace"))
